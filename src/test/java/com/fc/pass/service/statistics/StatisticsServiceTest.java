...
class StatisticsServiceTest {
    ...
    class MakeChartData {
        ...
        final LocalDateTime to = LocalDateTime.of(2023, 6, 8, 0, 0);
        ...
        void makeChartData_when_hasStatistics() {
            ...
            //when
            when(statisticsRepository.findByStatisticsAtBetweenAndGroupBy(eq(to.minusDays(10)), eq(to)))
            ...
            assertEquals(new ArrayList<>(List.of("06-07", "06-08")), chartData.getLabels());
        ...
        @Test
        void makeChartData_when_hasNoStatistics() {
            //when
            when(statisticsRepository.findByStatisticsAtBetweenAndGroupBy(eq(to.minusDays(10)), eq(to)))
